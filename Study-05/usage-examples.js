...
async function basicSummarizationExample() {
    ...
    // Sample text
    const sampleText = `
    Advances in artificial intelligence (AI) technology are bringing innovative changes to
    every area of modern society. In natural language processing in particular, the emergence
    of large language models has greatly improved text understanding and generation
    capabilities. Models such as GPT, BERT, and T5 are showing human-level performance on
    a variety of tasks including translation, summarization, and question answering.

    These technological advances are also being actively applied in specialized fields such
    as education, healthcare, finance, and law. For example, in healthcare, AI is used for
    medical image analysis and diagnostic support systems, and in finance it is applied to
    algorithmic trading and risk management.

    However, along with the rapid development of AI technology, concerns about ethical
    issues and social impact are also being raised. It is time for a careful approach to
    issues such as privacy protection, algorithmic bias, and job displacement.
    `;
...
- Medical accuracy and patient safety come first
...
- Side effects and risk factors`
    ...
    const medicalText = `
    The patient is a 65-year-old man who presented with chest pain persisting for 3 days.
    Electrocardiography showed ST-segment elevation, and cardiac enzyme levels were
    elevated, leading to a diagnosis of acute myocardial infarction. Emergency cardiac
    catheterization confirmed a complete occlusion of the proximal left anterior descending
    artery, and stent placement was completed successfully.
    `;
