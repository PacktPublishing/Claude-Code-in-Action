...
class ErrorHandler {
    ...
    generateUserMessage(error) {
        ...
        const userMessages = {
            [ErrorHandler.ErrorTypes.NETWORK_ERROR]: 'There is a problem with the network connection. Please check your internet connection.',
            [ErrorHandler.ErrorTypes.TIMEOUT_ERROR]: 'The request timed out. Please try again in a moment.',
            [ErrorHandler.ErrorTypes.AUTHENTICATION_ERROR]: 'The API key is invalid. Please check your settings.',
            [ErrorHandler.ErrorTypes.AUTHORIZATION_ERROR]: 'You do not have access permission. Please check your account settings.',
            [ErrorHandler.ErrorTypes.RATE_LIMIT_ERROR]: 'Too many requests. Please try again in a moment.',
            [ErrorHandler.ErrorTypes.QUOTA_EXCEEDED_ERROR]: 'You have exceeded your usage quota. Please check your plan.',
            [ErrorHandler.ErrorTypes.SERVER_ERROR]: 'The server is experiencing a temporary problem. Please try again in a moment.',
            [ErrorHandler.ErrorTypes.SERVICE_UNAVAILABLE_ERROR]: 'The service is temporarily unavailable.',
            [ErrorHandler.ErrorTypes.VALIDATION_ERROR]: 'There is a problem with the input data. Please check your content.',
            [ErrorHandler.ErrorTypes.UNKNOWN_ERROR]: 'An unknown error occurred. If it persists, please contact the administrator.'
        };
