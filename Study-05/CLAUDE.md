...
Study-05 is the Empathy AI Diary web application. It uses AI to analyze emotions from diary entries and provide empathetic responses. The app features a clean, responsive interface with local storage for diary entries.
...
- Uses the Google Gemma 4 26B model via OpenRouter
...
### Supported Emotions
- joy - Happy face emoji
- sadness - Sad face emoji
- anger - Angry face emoji
- fear - Fearful face emoji
- surprise - Surprised face emoji
- calm - Calm face emoji
- mixed - Mixed emotions emoji
...
This project lives in the `Study-05` folder of the repository.