...
class ImageProcessor:
    ...
    def validate_image(file) -> Tuple[bool, str]:
        ...
        if extension not in Config.ALLOWED_EXTENSIONS:
            return False, f"Unsupported file format. (Only {', '.join(Config.ALLOWED_EXTENSIONS)} are supported)"
        ...
        if file_size > Config.MAX_IMAGE_SIZE:
            return False, f"File size is too large. (Maximum {Config.MAX_IMAGE_SIZE // (1024*1024)}MB)"
