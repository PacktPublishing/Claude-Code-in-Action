...
class UserProfileManager:
    ...
    def create_profile(self, user_id: str, profile_data: Dict) -> bool:
        ...
        self.profiles[user_id] = {
            ...
            "cooking_level": profile_data.get('cooking_level', 'Beginner'),
            "dietary_preferences": profile_data.get('dietary_preferences', []),
            "allergies": profile_data.get('allergies', []),
            "favorite_cuisine": profile_data.get('favorite_cuisine', ['Korean']),
    ...
    def get_statistics(self, user_id: str) -> Dict:
        ...
        if user_id in self.saved_recipes:
            ...
            for recipe_data in user_data['recipes'].values():
                ...
                cuisine = recipe.get('cuisine', 'Korean')
    ...
    def get_recommendations(self, user_id: str, limit: int = 5) -> List[Dict]:
        ...
        favorite_cuisine = profile.get('favorite_cuisine', ['Korean'])
        dietary = profile.get('dietary_preferences', [])
        allergies = profile.get('allergies', [])
        skill_level = profile.get('cooking_level', 'Beginner')
        ...
        difficulty = skill_map.get(skill_level, 'Normal')

        # Sample recommendations based on preferences
        sample_recipes = [
            {"name": "Kimchi Stew", "cuisine": "Korean", "difficulty": "Easy", "time": 30},
            {"name": "Soybean Paste Stew", "cuisine": "Korean", "difficulty": "Easy", "time": 25},
            {"name": "Spicy Stir-Fried Pork", "cuisine": "Korean", "difficulty": "Normal", "time": 30},
            {"name": "Bibimbap", "cuisine": "Korean", "difficulty": "Normal", "time": 20},
            {"name": "Bulgogi", "cuisine": "Korean", "difficulty": "Normal", "time": 40},
        ]

        for recipe in sample_recipes:
            if recipe['cuisine'] in favorite_cuisine:
                if recipe['difficulty'] == difficulty or difficulty == 'Expert':
