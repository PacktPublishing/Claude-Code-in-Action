...
**IMPORTANT**: The git repository is currently initialized at the user home directory level rather than at the project level. This causes it to track system files unnecessarily. When working on this project:
